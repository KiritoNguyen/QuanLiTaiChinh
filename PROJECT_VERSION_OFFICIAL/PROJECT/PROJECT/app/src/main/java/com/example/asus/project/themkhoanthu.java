...
public class themkhoanthu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_themkhoanthu);
        ...
        add = (Button) findViewById(R.id.btnaddthu);
        show = (Button) findViewById(R.id.btnshowthu);
...
//                txtshow.setMovementMethod(new ScrollingMovementMethod());
                ...
                Intent i=new Intent(themkhoanthu.this,DS_khoanthu.class);
                startActivity(i);
                byBundle();
            }
        });
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (money.getText().toString().trim().length() == 0)
                    ...
                    dataBase_handler.add_thu(tv.getText().toString(), Long.parseLong(money.getText().toString()), txtcalendar.getText().toString());
    ...
    {
        Intent intent=new Intent(themkhoanthu.this,DS_khoanthu.class);
        Bundle bundle=new Bundle();
        bundle.putStringArrayList(TITLE,dataBase_handler.showallthu());
