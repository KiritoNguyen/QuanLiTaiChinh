...
public class CustomDialog_Thu extends Dialog {
    String arr[] = {"Lương thưởng", "Kinh doanh", "Nhận lãi"};
    String str=null;
    ...
    public CustomDialog_Thu(Activity a,String s) {
        super(a);
        this.c=a;
        str=s;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_dialog__thu);


        tv = (TextView) findViewById(R.id.tvcustom_thu);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getContext(), android.R.layout.simple_spinner_item, arr);
        adapter.setDropDownViewResource(android.R.layout.simple_list_item_single_choice);
        spinner=(Spinner)findViewById(R.id.spinnercustom_thu);
        ...
        calendar = (Button) findViewById(R.id.btncalendarcustom_thu);
        ...
        delete=(Button)findViewById(R.id.btndeletecustom_thu);
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dataBase_handler.delete_thu(str);
                show("Xóa thành công ");
        ...
        note=(EditText)findViewById(R.id.edt_ghichuthucustom);
        update=(Button)findViewById(R.id.btnupdatecustom_thu);
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (money.getText().toString().trim().length() == 0 )
                {
                    ...
                    dataBase_handler.updatethu(str, s1, s2, s3,s4);
        ...
        cancel=(Button)findViewById(R.id.btncancelcustom_thu);
